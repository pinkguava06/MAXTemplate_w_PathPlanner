...
public final class Constants {
  ...
  public static final class DriveConstants {
    ...
    public static final double kFrontLeftChassisAngularOffset = -Math.PI + .15;	     //yes, these look bad, but it works for us
    public static final double kFrontRightChassisAngularOffset = -Math.PI/8 - .2;    //2024 REV template worked fine, but I had to change these this year
    public static final double kBackLeftChassisAngularOffset = Math.PI/2;
    public static final double kBackRightChassisAngularOffset = Math.PI * 3 / 8 - .1;
